...
<body>
    ...
    <p style="text-align: center; font-size: 30px;"><br><br><br><br>Logged out successfully</p>
<?php endif; ?>

<a href="homepage.php" style="display: block; text-align: center; font-size: 24px;">Login</a>
